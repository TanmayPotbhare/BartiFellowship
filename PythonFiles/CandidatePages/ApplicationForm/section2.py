    ...
    def section2():
        ...
        if record:
            ...
            return render_template('CandidatePages/ApplicationForm/section2.html', record=record, university_data=university_names,
                                   ...
                                   formatted_phd_reg_date=formatted_phd_reg_date, cities=cities,lock_application_form=lock_application_form,
    ...
    def section2_submit():
        ...
        try:
            ...
            if request.method == 'POST':
                ...
                have_you_qualified = ','.join(qualified_exams) if qualified_exams else None
                ...
                values = (
                    ...
                    name_of_guide, faculty, other_faculty, research_center_district, section2, email
                )
                cursor.execute(sql, values)
                cnx.commit()
                flash('Qualification details updated successfully!', 'success')
        ...
        #             graduation_passing_year, graduation_percentage, graduation_school_name, grad_stream, grad_attempts, grad_total,
        #             phd_passing_year, phd_percentage, phd_school_name, pg_stream, pg_attempts, pg_total,
        #             have_you_qualified, have_you_qualified_other, phd_registration_date, fellowship_application_year, phd_registration_day,
        #             phd_registration_month, phd_registration_year, phd_registration_age, concerned_university,
        #             other_university, name_of_college, other_college_name, department_name, topic_of_phd,
        #             name_of_guide, faculty, other_faculty, research_center_district
        ...
        #             cursor.execute(sql, values)
        #             cnx.commit()
        #             flash('Qualification details saved successfully!', 'success')
